...
-- Adds teacher comments on grades and narrative student reviews
...
COMMENT ON TABLE student_reviews IS 'Teacher narrative reviews / report card comments per student and term.';
