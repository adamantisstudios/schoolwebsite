...
import { Smile, Clock, Users } from "lucide-react"

export default function RegisterToddlerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const message = `🌟 TODDLER PROGRAM APPLICATION 🌟
...
Program: Toddler Community (Ages 18 months - 3 years)
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <div>
                <h1 className="font-serif text-4xl font-bold text-foreground">Toddler Program Application</h1>
                <p className="text-primary font-medium text-xl">Ages 18 months - 3 years</p>
              </div>
            </div>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Complete this application to enroll your child in our nurturing Toddler Community program.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              ...
              <CardContent className="text-center">
                <p className="text-2xl font-bold text-primary">GHS 800</p>
                <p className="text-sm text-muted-foreground">Includes snacks</p>
              </CardContent>
            </Card>
          </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="part-time-2">Part Time (2 days)</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
